          ...
          <div className="lg:col-span-4 flex flex-col gap-16">
            ...
            <div>
              ...
              <div className="flex gap-6">
                <a href="#" aria-label="Instagram" className="text-on-surface-variant hover:text-primary transition-transform hover:scale-110 duration-200" title="Instagram">
                ...
                <a href="#" aria-label="Shopee" className="text-on-surface-variant hover:text-primary transition-transform hover:scale-110 duration-200" title="Shopee">
